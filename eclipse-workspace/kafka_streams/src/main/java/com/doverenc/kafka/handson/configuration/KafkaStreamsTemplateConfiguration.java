...
@Configuration
@EnableKafkaStreams
public class KafkaStreamsTemplateConfiguration {
	...
	public KStream<String, String> kStream(StreamsBuilder streamsBuilder) {
		...
		final KTable<String, Long> counts = stream
	...
	public KafkaStreamsConfiguration kafkaStreamsConfigs() {
		...
		props.putIfAbsent(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, BOOTSTRAP_SERVER);
