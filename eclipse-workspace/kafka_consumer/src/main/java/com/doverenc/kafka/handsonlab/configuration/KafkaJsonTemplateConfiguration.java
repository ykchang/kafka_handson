package com.doverenc.kafka.handsonlab.configuration;
...
public class KafkaJsonTemplateConfiguration {
	...
	private ConsumerFactory<? super String, ? super Animal> animalConsumerFactory() {
		return new DefaultKafkaConsumerFactory<>(producerProps(), new StringDeserializer(),
